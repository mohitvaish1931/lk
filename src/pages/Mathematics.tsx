...
const Mathematics = () => {
  ...
  const chapters = [
    {
      ...
      description:
        "Learn the basics of algebraic expressions, equations, and inequalities",
      topics: [
        "Linear Equations",
        "Quadratic Functions",
        "Polynomials",
    ...
    },
    {
      ...
      description:
        "Explore geometric shapes, angles, and trigonometric functions",
      topics: [
        "Triangles",
        "Circles",
    ...
    },
    {
      ...
      description:
        "Learn data analysis, probability theory, and statistical methods",
      topics: [
        "Data Analysis",
        "Probability",
        "Normal Distribution",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header Section */}
      <section className="relative bg-gradient-to-br from-learnkins-blue-500 to-learnkins-blue-600 text-white py-20">
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h1 className="text-5xl font-bold mb-4">Mathematics</h1>
              <p className="text-xl text-blue-100 max-w-2xl">
                Master mathematical concepts from basic arithmetic to advanced
                problem-solving techniques. Develop logical thinking and
                analytical skills through interactive learning.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600">
                  Master mathematical concepts through comprehensive study
                  materials
                </p>
              </div>
                    ...
                    {chapters.map((chapter) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link
                            to={`/subjects/mathematics/${chapter.id}`}
                ...
                {chapters.map((chapter) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <Link
                        to={`/subjects/mathematics/${chapter.id}/videos`}
          ...
          {activeTab === "assessments" && (
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600">
                  Practice worksheets and assessments to test your mathematical
                  skills
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    id: "math-1",
                    title: "Square and Cube Numbers Assessment",
                    description:
                      "Test your understanding of square and cube numbers, their properties, and applications",
                    difficulty: "Intermediate",
                    timeLimit: "10 min",
                    questions: 5,
                    subject: "Mathematics",
                  ...
                  {
                    id: "math-2",
                    title: "Arithmetic Expressions Quiz",
                    description:
                      "Practice evaluating arithmetic expressions using order of operations",
                    difficulty: "Beginner",
                    timeLimit: "8 min",
                    questions: 5,
                    subject: "Mathematics",
                  ...
                  {
                    id: "math-3",
                    title: "Geometry Fundamentals Test",
                    description:
                      "Test your knowledge of basic geometric concepts and shapes",
                    difficulty: "Beginner",
                    timeLimit: "10 min",
                    questions: 5,
                    subject: "Mathematics",
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      ...
                      <a
                        href={`/${
                          assessment.id === "math-1"
                            ? "(1)Square and Cube.docx"
                            : assessment.id === "math-2"
                            ? "(2)Arithmetic Expressions.docx"
                            : assessment.id === "math-3"
